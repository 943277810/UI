<template>
    <div>
        ...
        <div class="rightbox">
                ...
                >
                    ...
                    <el-table-column prop="action" label="操作" width="100">
                        <template slot-scope="scope">
                            ...
                            <i class="el-icon-delete" @click="del(scope.row.department_id )"></i>
                            <i class="el-icon-edit" @click="findbyid(scope.row.department_id )"></i>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
            ...
            <!-- 添加字典弹窗 -->
            <div>
                <el-dialog title="新增部门基本信息" :visible.sync="dialogFormVisible" @close="clear">
                    <hr />
                    <h2 style="color: blue;text-align: left;font-style: italic">部门的基本信息</h2>
                    <hr />
                    <el-form v-model="form" style="text-align: left" ref="dataForm">
                        ...
                        <el-form-item label="部门编号" :label-width="formLabelWidth" prop="code">
                            <el-input v-model="form.code" placeholder="部门编号"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="部门等级:" :label-width="formLabelWidth">
                        ...
                        <el-form-item label="上级部门:" :label-width="formLabelWidth">
                            <el-select v-model="form.supdepartment" clearable placeholder="请选择">
                                <el-option
                                        v-for="item in options"
                                        :key="item.value"
                                        :label="item.label"
    ...
    export default {
        ...
        methods: {
            ...
            edit() {
                this.$axios
                    .post("/update", {
                        department_id : this.upform.id,
                        name: this.upform.name,
                        code: this.upform.code,
                        mnemoniccode: this.upform.mnemoniccode,
                        level: this.upform.level,
                        supdepartment: this.upform.supdepartment,
