<template>
    <div>
        <div class="leftbox">
            <span class="el-icon-notebook-1">&nbsp;资源管理</span>
            <br>
        ...
        <div class="rightbox">
            ...
            <el-form :inline="true" :model="searchpath" class="demo-form-inline" style="float:left">
                ...
                <el-form-item label="父亲节点">
                    <el-input type="text" v-model="searchpath.name" placeholder="父亲节点"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <div>
                ...
                >
                    ...
                    <el-table-column prop="supnode" label="父亲节点" sortable width="100"></el-table-column>
                    <el-table-column prop="url" label="URL" width="100"></el-table-column>
                    <el-table-column prop="resourcetype" label="资源类型" sortable  width="100"></el-table-column>
                    <el-table-column prop="sequencenumber" label="顺序号"  width="100"></el-table-column>
                    <el-table-column prop="icon" label="图标"  width="150"></el-table-column>
                    <el-table-column prop="start" label="是否叶节点" sortable width="100"></el-table-column>
      ...
      padding: 0px;">
                    ...
                    <el-dialog :title="dialogTitle" style="padding: 0px;" :close-on-click-modal="false"
                        ...
                        <el-form-item label="节点名称" :label-width="formLabelWidth" prop="name">
                            <el-input v-model="dictionary.name" placeholder="节点名称"></el-input>
                        </el-form-item>
                        <el-form-item label="节点编号" :label-width="formLabelWidth" prop="code">
                            <el-input v-model="dictionary.code" placeholder="节点编号"></el-input>
                        </el-form-item>
                        <el-form-item label="父亲节点" :label-width="formLabelWidth" prop="supnode">
                            <el-input v-model="dictionary.supnode" placeholder="父亲节点"></el-input>
                        </el-form-item>
                        <el-form-item label="URL" :label-width="formLabelWidth" prop="url">
                            <el-input v-model="dictionary.url" placeholder="URL"></el-input>
                        </el-form-item>
                        <el-form-item label="资源类型" :label-width="formLabelWidth" prop="resourcetype">
                            <el-input v-model="dictionary.resourcetype" placeholder="资源类型"></el-input>
                        </el-form-item>
                        <el-form-item label="关闭图标" :label-width="formLabelWidth" prop="off">
                            <el-input v-model="dictionary.off" placeholder="关闭图标"></el-input>
                        </el-form-item>
                        <el-form-item label="打开图标" :label-width="formLabelWidth" prop="on">
                            <el-input v-model="dictionary.on" placeholder="打开图标"></el-input>
                        </el-form-item>
                        <el-form-item label="是否叶节点" :label-width="formLabelWidth" prop="start">
