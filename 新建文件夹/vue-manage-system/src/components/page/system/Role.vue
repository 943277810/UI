        ...
        <div class="rightbox">
            ...
            <el-form :inline="true" :model="searchpath" class="demo-form-inline" style="float:left">
                <el-form-item label="角色名称">
                    <el-input type="text" v-model="searchpath.name" placeholder="角色名称"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <div style="float:left">
                ...
                <label>&nbsp;&nbsp;&nbsp;&nbsp;</label>
                <el-button type="text"  class="el-icon-circle-plus-outline" style="font-size: 15px" @click="resourceManagement">资源分配</el-button>
                <label>&nbsp;&nbsp;&nbsp;&nbsp;</label>
                <el-button type="text" class="el-icon-user" style="font-size: 15px" @click="goUserAllocation">用户分配</el-button>
            </div>
            ...
            <div>
                ...
                >
                    ...
                    <el-table-column prop="SoleName" label="角色名称" width="140"></el-table-column>
                    <el-table-column prop="SoleCode " label="角色代号" width="140"></el-table-column>
                    <el-table-column prop="SoleRemark" label="角色备注" width="140"></el-table-column>
                    <el-table-column prop="Company" label="所属公司" width="140"></el-table-column>
                    <el-table-column prop="Organization" label="所属机构" sortable width="140"></el-table-column>
                    <el-table-column prop="StartTag" label="启用标记" sortable width="140"></el-table-column>
      ...
      padding: 0px;">
                    ...
                    <el-dialog :title="dialogTitle" style="padding: 0px;" :close-on-click-modal="false"
                        ...
                        <el-form-item label="角色名称" :label-width="formLabelWidth" prop="name">
                            <el-input v-model="dictionary.name" placeholder="角色名称"></el-input>
                        </el-form-item>
                        <el-form-item label="角色代号" :label-width="formLabelWidth" prop="code">
                            <el-input v-model="dictionary.code" placeholder="角色代号"></el-input>
                        </el-form-item>
                        <el-form-item label="角色备注" :label-width="formLabelWidth" prop="SoleRemark">
                            <el-input v-model="dictionary.SoleRemark" placeholder="角色备注"></el-input>
                        </el-form-item>
                        <el-form-item label="所属机构:" :label-width="formLabelWidth" prop="level">
                            <el-select v-model="dictionary.level" clearable placeholder="请选择">
                                <el-option
                        ...
                        <el-form-item label="所属公司:" :label-width="formLabelWidth" prop="supdepartment">
                            <el-select v-model="dictionary.supdepartment" clearable placeholder="请选择">
                                <el-option
                                        v-for="item in options"
                                        :key="item.value"
                                        :label="item.label"
                        ...
                        <el-form-item label="是否启用" :label-width="formLabelWidth" prop="start">
            ...
            <el-button size="mini" type="primary" @click="addDictionary()">保 存</el-button>
               ...
               <!--资源分配-->
            <div>
                <el-dialog title="资源分配" width="30%" :visible.sync="dialogResource" :before-close="handleClose" :close-on-click-modal="true">
            <el-tree :data="resource" :props="defaultProps" @node-click="handleNodeClick"></el-tree>
        </el-dialog>
        </div>
            <!-- 添加导入文件对话框 -->
            <div>
