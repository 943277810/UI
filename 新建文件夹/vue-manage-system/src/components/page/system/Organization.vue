    ...
    <div>
        ...
        <div>
            ...
            >
                ...
                <el-table-column prop="name" label="组织机构" width="110"></el-table-column>
                <el-table-column prop="code" label="机构代码" sortable width="130"></el-table-column>
                ...
                <el-table-column prop="start" label="是否启用" sortable width="140"></el-table-column>
      ...
      padding: 0px;">
                ...
                <el-dialog :title="dialogTitle" style="padding: 0px;" :close-on-click-modal="false"
                    ...
                    <el-form-item label="组织机构名" :label-width="formLabelWidth" prop="name">
                        <el-input v-model="dictionary.name" placeholder="组织机构名"></el-input>
                    </el-form-item>
                    <el-form-item label="机构代码" :label-width="formLabelWidth" prop="code">
                        <el-input v-model="dictionary.code" placeholder="机构代码"></el-input>
                    </el-form-item>
