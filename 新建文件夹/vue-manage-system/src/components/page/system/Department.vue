        ...
        <div class="rightbox">
            ...
            <el-form :inline="true" :model="searchpath" class="demo-form-inline" style="float:left">
                <el-form-item label="部门名称">
                    <el-input type="text" v-model="searchpath.name" placeholder="部门名称"></el-input>
                </el-form-item>
            ...
            <div>
                <el-table
                        ...
                        :default-sort="{prop: 'supdepartment，start，level', order: 'descending'} "
                >
                    <el-table-column type="selection" width="55"></el-table-column>
                    <el-table-column prop="name" label="部门名称" width="100"></el-table-column>
                    <el-table-column prop="supdepartment" label="上机部门" sortable width="100"></el-table-column>
                    ...
                    <el-table-column prop="level" label="部门等级" sortable  width="100"></el-table-column>
                    <el-table-column prop="start" label="启用标记" sortable width="100"></el-table-column>
      ...
      padding: 0px;">
                    ...
                    <el-dialog :title="dialogTitle" style="padding: 0px;" :close-on-click-modal="false"
                        ...
                        <el-form-item label="部门名称" :label-width="formLabelWidth" prop="name">
                            <el-input v-model="dictionary.name" placeholder="部门名称"></el-input>
                        </el-form-item>
                        <el-form-item label="部门编号" :label-width="formLabelWidth" prop="code">
                            <el-input v-model="dictionary.code" placeholder="部门编号"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="部门等级:" :label-width="formLabelWidth" prop="level">
                        ...
                        <el-form-item label="上级部门:" :label-width="formLabelWidth" prop="supdepartment">
                        ...
                        <el-form-item label="负责人" :label-width="formLabelWidth" prop="master">
                            <el-input v-model="dictionary.master" placeholder="负责人"></el-input>
                        </el-form-item>
            ...
            addDictionary() {
                this.$axios
                    .post("/add", {
                        ...
                        supdepartment: this.form.supdepartment,
